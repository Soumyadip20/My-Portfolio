...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    if (clientName && email && EmailValidation(email) && messages) {
      axios.post("https://getform.io/f/DdwO9gd1", {
        name: clientName,
        email: email,
        message: messages,
      });
    ...
    <div className="w-full">
      ...
      <div className="w-full mt-10">
        ...
        {seuccessMsg ? (
          ...
          <form
            id="form"
            action="https://getform.io/f/DdwO9gd1"
            method="POST"
      ...
      <div className="absolute bottom-0 left-0 w-full text-center py-4 text-white-400 text-sm">
        Crafting Ideas, Designing Futures 🎨✨
      </div>
    </div>
  );
};
